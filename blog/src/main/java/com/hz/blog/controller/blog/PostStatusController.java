...
public class PostStatusController {
    ...
    public ResponseResult getLabel(String status){
    ...
    @ApiImplicitParam(name = "status", value = "需要请求的label名",required = true, paramType="query")
    public ResponseResult updateLabel(BlogStatus status){
    ...
    public ResponseResult addLabel(@RequestBody() @ApiParam(name = "body",value = "Status信息",required = true) @Validated BlogStatus status){
    ...
    @ApiImplicitParam(name = "status", value = "需要请求的status名",required = true, paramType="query")
    public ResponseResult deleteLabel(String statusId){
